<template>
    <div class="flex flex-col space-y-36">
        ...
        >
            <img
                src="/collage.jpg"
                class="absolute z-10 object-cover h-full lg:w-full"
            />
            <div class="bg-black/40 absolute inset-0 w-full z-20" />
            <div
                class="relative z-30 flex flex-col lg:flex-row items-center space-y-8 lg:space-y-0 lg:space-x-8 px-4 py-12 mt-24 lg:mt-72 max-w-8xl mx-auto justify-between h-[22rem]"
                data-aos="fade-up"
        ...
        <div
            id="about"
            class="flex flex-col space-y-4 px-1 max-w-7xl mx-auto py-4"
        >
            <div
                data-aos="fade-up"
                data-aos-easing="linear"
        ...
        >
            ...
            >
                ...
                >
                <ul
                    class="flex flex-col items-left space-y-2 text-justify list-outside lg:list-outside list-disc"
                >
                    <li
                        v-for="(desc, i) in [
            ...
            >
                ...
                <ul
                    class="flex flex-col items-left space-y-2 text-justify list-disc list-outside lg:list-outside"
                >
                    <li
                        v-for="(desc, i) in [
        ...
        <div
            id="aim"
            class="flex flex-col space-y-4 px-1 max-w-7xl mx-auto py-12"
        >
            <div
                data-aos="fade-up"
                data-aos-easing="linear"
        ...
        <div class="bg-gray-700 text-white">
            ...
            >
                <div
                    class="text-4xl font-semibold mx-auto text-center uppercase"
                >
                    Volunteers
                </div>
        ...
        <div class="w-full py-2 mx-auto space-y-8">
            ...
            <div
                id="leaders"
                class="max-w-7xl mx-auto grid grid-cols-1 gap-8 items-center justify-between w-full"
                data-aos="fade-up"
                data-aos-easing="linear"
                data-aos-delay="100"
                data-aos-duration="260"
    ...
    <div
        class="p-2 flex py-16 flex-col item-center text-black stroke-black ml-auto"
    >
        <CardContact />
    </div>
</template>
