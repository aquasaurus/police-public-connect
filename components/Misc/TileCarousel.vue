  ...
  <div class="w-full flex flex-col items-center">
    ...
    >
      ...
      >
        ...
        >
          <img
            :src="`/data/${item.images}/${item.images === 12 ? 4 : 1}.jpeg`"
            class="h-72 w-full object-cover mx-auto"
          />
          <img
            :src="`/data/${item.images}/${item.images === 12 ? 5 : 2}.jpeg`"
            class="h-72 w-full object-cover mx-auto"
          />
          <img
            :src="`/data/${item.images}/${item.images === 12 ? 4 : 3}.jpeg`"
            class="h-72 w-full object-cover mx-auto"
          />
          <img
            :src="`/data/${item.images}/${item.images === 12 ? 5 : 4}.jpeg`"
            class="h-72 w-full object-cover mx-auto"
          />
          <span
            class="
...
const next = () =>
  current.value === images.length - 1 ? (current.value = 0) : current.value++;
const prev = () =>
  current.value === 0 ? (current.value = images.length - 1) : current.value--;
</script>