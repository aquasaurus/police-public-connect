<template>
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start max-w-8xl mx-auto py-8">
        ...
        <div class="flex flex-col space-y-1 break-words">
            <span class="font-semibold text-lg uppercase">Contact Number</span>
        ...
        <div class="flex flex-col space-y-1 break-words">
            <span class="font-semibold text-lg uppercase">Date of Birth</span>
        ...
        <div class="flex flex-col space-y-1 break-words ">
            ...
            <span class="text-base">{{
                userInfo.user_health_desc || "None"
            }}</span>
        </div>
        <!--
                            <div class="flex flex-col space-y-1 break-words">
                        ...
                        -->
        <div class="flex flex-col space-y-1 break-words">
            <span class="font-semibold text-lg uppercase">Account Type</span>
            <span class="text-base">{{
